...
function fact_dev($num )
{
    ...
    $this->Cell($rt2-$rt -1,6, "Reporte de ventas del ". $_GET["fecha_inicio"]. " al " . $_GET["fecha_final"], 'B', 0, "C", );
}
...
function addClientAdresse( $cliente, $domicilio ,$email, $telefono, $marca, $modelo, $placas, $color, $kms )
{
    ...
    $r2     = $r1 + 68;
    $y1     = 60;
    $this->Image('../files/images/BrakeOneBrembo.png',90,8,120);
...
function ImprovedTable($header)
{
    ...
    $this->SetXY( $this->w - 280, 10 + 35 );
    // Anchuras de las columnas
    $w = array(10, 17, 19, 55, 16, 42, 22, 26, 24, 20, 28);
    // Cabeceras
...
function ImprovedTable2($data) {                
    $w = array(0.2, 10, 11, 47, 8, 34, 14, 18, 16, 15, 15);
...
function addCadreEurosFrancs($impuesto)
{
    ...
    $this->SetXY( $r1+22, $y1 );
    $this->Cell(35,4, "TOTAL VENTAS", 0, 0, "C");
}
