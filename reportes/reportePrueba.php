...
$venta= new Servicios();
$rsptav=$venta->serviciodetalles('56');
$rsptaS=$venta->serviciocabecera('56');
...
class pdf extends FPDF
{
	...
	{        
        ...
        $this->Image('../files/images/S-BRAKES.PNG',68,8,80);
	...
	public function footer()
	{
		...
		$this->Ln();
		$this->SetX(68);
		$this->Write(4, 'SARATOGA #313-C, COL. PORTALES NORTE ALCALDIA BENITO JUAREZ, CDMX. CP. 03303');
		$this->SetX(120);
		$this->Ln();
		$this->SetX(141);
