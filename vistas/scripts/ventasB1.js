...
function guardarArticuloSolicitud() {	
	...
	console.log("marcaproducto: ", marcaproducto);
	...
	console.log("notaAdicional: ", notaAdicional);
	console.log("idsucursalProducto: ", idsucursalProducto);
...
function crearVenta() {	
	console.log("REMISIÓN: ", $("#remision").val());
	mostrarform(true);
	$("#btnGuardar").show();
